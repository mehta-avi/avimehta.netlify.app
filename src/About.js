  ...
  return (
    <div className="bg-slate-500 text-white py-14 px-12">
      <div className="max-w-screen-2xl	">
        <div className="flex">
          ...
          <div className="flex justify-end">
            <img src="pylons_pic.jpg" alt="Portrait at the Pylons" style={{ width: '525px', height: '750px', borderRadius: '14px' }}   />
          </div>
        </div>
      ...
      <div className='w-full'>
        <h2 className='text-4xl text-center pt-16'> Get to know me! </h2>
          <p className="text-lg text-center py-5 mx-auto max-w-xl">
